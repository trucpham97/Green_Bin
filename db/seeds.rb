...
product = Product.new(
  ...
  description: '1 boîte de conserve en aluminium à recycler, 1 emballage carton à recycler',
...
product = Product.new(
  ...
  description: '1 bouteille en verre à recycler, 1 bouchon en plastique à trier',
